...
def lvpart():
  ...
  #  dic_base_path = 'D:/JiajunLv/图神经网络/vec/'
  #  dic_base_path = 'D:/JiajunLv/图神经网络/vec4/'
    dic_base_path = './图神经网络/vec26/'
    model_store_base_path = './图神经网络/testcfg/trained/'
    unique_fun_base_path = './图神经网络/UniqueFunList/'
    nd_stg_type = '1'
    md_type = '1'
    black_list = []
