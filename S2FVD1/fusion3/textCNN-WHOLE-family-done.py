...
def neural_net_train(model, x_train, y_train, val_split=0., validation_data=None, fig_prefix=''):
    """
    训练神经网络
    :return:
    """
...
def run_whole_procedure(fig_prefix,df):
    """
    ...
    """
    ins_abs_stgs = ['coarse']
    dic_base_path = 'C:/Users/lvjiajun/Desktop/file/code/'
    ...
    # model = neural_net_train(model, x_train=x_train, y_train=y_train, val_split=dataset_split_ratio, fig_prefix=fig_prefix)  # this should be the correct way
    ...
    model_evaluaiton(model)


def TextCnn(df):
    dic_base_path = 'C:/Users/lvjiajun/Desktop/file/code/'
    model_store_base_path = 'C:/Users/lvjiajun/Desktop/file/code/'
    unique_fun_base_path = 'C:/Users/lvjiajun/Desktop/file/code/'
    ...
    label_strs = ['cwe-119 false', 'cwe-119 true']
    global label_strs
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            ...
            run_whole_procedure(model_name.replace('.h5', ''),df)
